...
# Tab 2 (Institutional Level Trends)
```{r in}

# Read excel sheet into object.
# This is for the first tab that calculates percentage of students receiving
...
# Public, private, and private institutions, and then combine them together.
# Added a column called "type" since I will use that to differentiate the
# type of insitution these these values represent.
...
# This calculates the amount across all institutions. 
...
# I'm going to suppress warnings here because it wants me to specify column 
# types for all of the 295 columns in the dataset, which will take up so much 
# unneccessary space on this rMarkdown document. 
...
# I was going to use this to graph something else, but realized it's no longere
# neccessary. Keeping this as a comment just to track my progress.
